...
class TrustedTimestamps
{
    ...
    public static function createRequestfile ($hash)
    {
        ...
        if (is_array($retarray) && isset($retarray[0]) && stripos($retarray[0], "openssl:Error") !== false)
        {
     ...
     */
    public static function signRequestfile ($requestfile_path, $tsa_url, $identifier, $secret)
    {
